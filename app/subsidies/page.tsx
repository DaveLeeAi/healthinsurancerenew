...
const FAQ_ITEMS = [
  ...
  { question: 'Who qualifies for ACA health insurance subsidies in 2026?', answer: 'For 2026, households earning from 100% to 400% of the Federal Poverty Level may qualify. The IRA enhanced credits that extended subsidies above 400% FPL expired at the end of 2025. The amount depends on your income, household size, and the benchmark Silver premium in your area.' },
