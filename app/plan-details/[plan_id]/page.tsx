...
import { getPlanById, getSbcByPlanVariantId, getDentalByState } from '@/lib/data-loader'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: description.slice(0, 160),
      type: 'website',
      url: `https://healthinsurancerenew.com/plan-details/${params.plan_id}`,
    },
    alternates: {
      canonical: `https://healthinsurancerenew.com/plan-details/${params.plan_id}`,
    },
  }
}
...
export default async function PlanDetailsPage({ params }: Props) {
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    { name: plan.plan_name, url: `https://healthinsurancerenew.com/plan-details/${params.plan_id}` },
  ])
  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        {/* Author Attribution */}
        <section aria-label="Author" className="mb-10 flex items-start gap-4 rounded-xl border border-neutral-200 p-5">
          ...
          <div>
            <p className="text-sm font-semibold text-neutral-800">
              Reviewed by Dave Lee, Licensed Health Insurance Agent
            </p>
            <p className="text-xs text-neutral-500 mt-0.5">
              CMS Elite Circle of Champions · Licensed in 20+ states · Serving ACA marketplace enrollees since 2014
            </p>
        ...
        <section aria-label="Data sources" className="mb-10">
          <h2 className="text-base font-semibold text-neutral-700 mb-2">Data Sources</h2>
          <ul className="text-sm text-neutral-500 space-y-1 list-disc list-inside">
            <li>
              <a href="https://www.cms.gov/marketplace/resources/data/public-use-files" className="underline hover:text-primary-600" target="_blank" rel="noopener noreferrer">
                CMS Plan Attributes PUF
              </a> — plan structure, deductibles, OOP maximums
            </li>
            <li>
              <a href="https://www.cms.gov/marketplace/resources/data/public-use-files" className="underline hover:text-primary-600" target="_blank" rel="noopener noreferrer">
                CMS Benefits & Cost Sharing PUF
              </a> — per-service copay and coinsurance data
            </li>
            <li>Plan year: {PLAN_YEAR} · Data extracted from CMS Public Use Files</li>
          </ul>
        </section>
