...
const breadcrumbs = [
  ...
  { name: 'Turning 26', url: '/turning-26-health-insurance-options' },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "It depends on your income and how much care you expect to use. If your income qualifies for cost-sharing reductions (below 250% FPL), a Silver plan gives you the best value. If you rarely see a doctor and want the lowest monthly premium, a Bronze plan may work — especially if paired with a Health Savings Account.",
  },
  {
    question: "Can I stay on my parent's plan if I'm married or have my own job?",
    answer:
      "Yes, until you turn 26. Under the ACA, you can remain on a parent's plan regardless of your marital status, employment status, student status, or whether you live with your parents. You do not need to be a tax dependent to stay on the plan.",
  },
  {
    question: "What if my employer offers insurance but it's expensive?",
    answer:
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <section className="mb-10">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4">
          <p className="text-sm text-amber-800">
            <strong>Do not wait.</strong> The 60-day window starts when your parent&apos;s coverage ends. If you miss
            it, you may be uninsured until the next open enrollment period.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-4">
          <div className="bg-white border border-slate-200 rounded-2xl p-5">
            ...
            <p className="text-slate-700 leading-relaxed font-serif">
              Many 26-year-olds qualify for significant premium help based on their income. If you are just starting
              a career or working part-time, your monthly cost for a Silver plan could be very low.
            </p>
          </div>

          <div className="bg-white border border-slate-200 rounded-2xl p-5">
            <h3 className="font-semibold text-slate-800 mb-2">2. Employer-Sponsored Coverage</h3>
            <p className="text-slate-700 leading-relaxed font-serif">
              If your employer offers health insurance, losing a parent&apos;s plan is usually a qualifying event
              that lets you enroll outside the employer&apos;s normal enrollment window. Employer plans may be a
              good option if your employer contributes to the premium, but compare the cost to marketplace options —
              especially if the employer plan is expensive.
            </p>
          </div>

          <div className="bg-white border border-slate-200 rounded-2xl p-5">
            <h3 className="font-semibold text-slate-800 mb-2">3. Medicaid</h3>
            <p className="text-slate-700 leading-relaxed font-serif">
              If your income is low enough and you live in a state that has expanded Medicaid, you may qualify for
              Medicaid coverage with little to no monthly cost. You can apply for Medicaid year-round — there is no
              enrollment deadline.
            </p>
          </div>

          <div className="bg-white border border-slate-200 rounded-2xl p-5">
            <h3 className="font-semibold text-slate-800 mb-2">4. Short-Term or Catastrophic Coverage</h3>
            <p className="text-slate-700 leading-relaxed font-serif">
              If you are between coverage options, a catastrophic plan (available to people under 30) provides basic
              protection at a lower premium. These plans have high deductibles and are mainly intended to protect you
              from worst-case scenarios. They do not qualify for premium tax credits.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal pl-5 text-slate-700 leading-relaxed font-serif space-y-3">
          ...
          <li>
            <strong>Calculate your income.</strong> Your marketplace savings depend on your{' '}
            <a href="/tools/what-income-counts" className="text-primary-600 hover:text-primary-700 underline">
              Modified Adjusted Gross Income
            </a>
            . Gather your pay stubs or tax return.
          </li>
          <li>
            <strong>Compare your options.</strong> Check both employer plans (if available) and marketplace plans.
            Use the{' '}
          ...
          <li>
            <strong>Confirm coverage start date.</strong> Make sure you know when your new plan begins so there is no
            gap.
          </li>
        </ol>
      </section>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Key Deadlines</h2>
        <div className="bg-white border border-slate-200 rounded-2xl p-5">
          <ul className="space-y-3 text-slate-700 leading-relaxed font-serif">
            <li><strong>60 days</strong> from losing parent&apos;s coverage to enroll in a marketplace plan</li>
            <li><strong>30 days</strong> from a qualifying event to enroll in most employer plans (check your employer&apos;s policy)</li>
            <li><strong>No deadline</strong> for Medicaid applications — you can apply any time of year</li>
          </ul>
        </div>
      </section>
