...
export const metadata: Metadata = {
  ...
  description:
    'Transparency about how HealthInsuranceRenew is funded. Learn about commissions from insurance carriers and how this does not affect consumers.',
}
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="prose prose-neutral max-w-none">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">
          There are no hidden fees, charges, or costs passed on to consumers.
        </h2>
        <p className="text-slate-700 leading-relaxed mb-4">
          Using this site, its educational content, tools, and calculators is free. Speaking with a licensed agent is
          also free. If a consumer chooses to enroll in a marketplace plan through an agent, the premium is the same
          as it would be if the consumer enrolled directly through HealthCare.gov or a state-based exchange. Agent
          commissions do not increase the cost of the plan.
        </p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">
          This disclosure is part of a broader commitment to transparency.
        </h2>
        <p className="text-slate-700 leading-relaxed mb-4">
